...
# =================================================================================
# التعديل الرئيسي: تحسين تعليمات SYSTEM_PROMPT لرفع دقة استخلاص جميع الحقول ورقم الدلالة
# =================================================================================
SYSTEM_PROMPT = (
    ...
    "**تعليمات الاستخلاص الرئيسية (لضمان استخلاص كل الحقول):** "
    "1. **توحيد الصيغ:** يجب تحويل جميع التواريخ إلى صيغة رقمية موحدة 'YYYY/MM/DD' وتحويل الأرقام العربية إلى إنجليزية. "
    "2. **الاستخلاص الشامل:** ابحث عن قيمة لكل حقل في القائمة. **ابذل قصارى جهدك للعثور على القيم من أي مكان في النص أو الجداول.** "
    "3. **حقل الهوية والسجل:** 'رقم الهوية' هو هوية الفرد (المواطن/المقيم)، و 'رقم صاحب العمل/السجل التجاري' هو رقم السجل التجاري للكيان. "
    "4. **القيمة الافتراضية:** **استخدم 'غير متوفر' فقط للحقول التي لا يمكن العثور عليها إطلاقاً** في الوثيقة. "
