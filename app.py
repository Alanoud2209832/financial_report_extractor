...
SYSTEM_PROMPT = (
    ...
    "لجميع حقول التاريخ (مثل 'تاريخ الصادر' و 'تاريخ الوارد')، يجب عليك استخلاص التاريخ الهجري وتحويله إلى صيغة رقمية موحدة 'السنة/الشهر/اليوم' (YYYY/MM/DD) مثل '1445/06/21'. "
...
SYSTEM_PROMPT = (
    ...
    "يجب عليك استخلاص جميع التواريخ الهجرية وتحويلها إلى **صيغة رقمية موحدة** 'السنة/الشهر/اليوم' (YYYY/MM/DD) مثل '1445/06/21'. "
